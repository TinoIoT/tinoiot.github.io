<?xml version="1.0" encoding="UTF-8"?><rss xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:atom="http://www.w3.org/2005/Atom" version="2.0"><channel><title><![CDATA[Your Site's RSS Feed]]></title><description><![CDATA[Welcome Everyone!]]></description><link>https://tinoiot.com</link><generator>GatsbyJS</generator><lastBuildDate>Tue, 25 Aug 2020 02:47:24 GMT</lastBuildDate><item><title><![CDATA[Sending Sensor Data to ThingSpeak]]></title><description><![CDATA[ This project is meant to give you a practical example of what you can do with IoT skills. We will…]]></description><link>https://tinoiot.com/tutorials/esp32-thingspeak-wm/</link><guid isPermaLink="false">https://tinoiot.com/tutorials/esp32-thingspeak-wm/</guid><pubDate>Sat, 22 Aug 2020 00:00:00 GMT</pubDate><content:encoded>&lt;img src=&quot;/static/94ca67d6860306e7484202df2a48c0ff/2244e/mainpic.jpg&quot;/&gt;&lt;h2&gt;What you will need:&lt;/h2&gt;
&lt;ul&gt;
...
&lt;li&gt;&lt;a href=&quot;https://www.amazon.com/DEYUE-breadboard-Set-Prototype-Board/dp/B07LFD4LT6/ref=sr_1_3?crid=1MRAUMDALD43Z&amp;#x26;dchild=1&amp;#x26;keywords=breadboard&amp;#x26;qid=1598139934&amp;#x26;s=electronics&amp;#x26;sprefix=bread%2Celectronics%2C213&amp;#x26;sr=1-3&quot;&gt;Bread board&lt;/a&gt; - Recommended for keeping things organized but not nessisary.&lt;/li&gt;
...
&lt;li&gt;&lt;a href=&quot;https://thingspeak.com/&quot;&gt;ThingSpeak Account&lt;/a&gt; - It’s free for up to 4 channels which are plenty.&lt;/li&gt;
&lt;/ul&gt;
&lt;h2&gt;Project Overview&lt;/h2&gt;
&lt;p&gt;This project is meant to give you a practical example of what you can do with IoT skills. We will be using the esp32 huzzah feather board as our microcontroller because it has the esp32 chip which can connect to the internet. We will use this connectivity to send an HTTP GET request to ThingSpeak periodically so we can chart the temperature where ever we decide to place our device.&lt;/p&gt;
...
&lt;p&gt;Now we’re going to install libraries to make it easier for us to interface with the bme280 and to connect to the internet.&lt;/p&gt;
...
&lt;h2&gt;Wiring&lt;/h2&gt;
&lt;p&gt;Connect the following pins with jumper cables (esp32 to bme280):&lt;/p&gt;
&lt;p&gt;&lt;strong&gt;3V&lt;/strong&gt; to &lt;strong&gt;VIN&lt;/strong&gt;&lt;/p&gt;
&lt;p&gt;&lt;strong&gt;GND&lt;/strong&gt; to &lt;strong&gt;GND&lt;/strong&gt;&lt;/p&gt;
&lt;p&gt;&lt;strong&gt;SCL&lt;/strong&gt; to &lt;strong&gt;SCK&lt;/strong&gt;&lt;/p&gt;
&lt;p&gt;&lt;strong&gt;SDA&lt;/strong&gt; to &lt;strong&gt;SDI&lt;/strong&gt;&lt;/p&gt;
&lt;p&gt;You can test if everything is wired correctly by running Adafruit’s example. It can be found at File &gt; Examples &gt; Adafruit BME280 Library &gt; bme280test. Because we are using I2C with the default pins we don’t have to modify anything in the example code. Run it and then open the Serial Monitor (Tools &gt;  Serial Monitor). You should see readings every second for each of the sensors that look something like this:&lt;/p&gt;
...
&lt;p&gt;Now let’s try sending some data to each of our channels four fields. Try out this code. &lt;strong&gt;Make sure to replace “YOUR&lt;em&gt;WIFI&lt;/em&gt;NAME” with your wifi name, “YOUR&lt;em&gt;WIFI&lt;/em&gt;PASSWORD” with your wifi password, and &lt;em&gt;serverName&lt;/em&gt; with your URL from ThingSpeak.&lt;/strong&gt;&lt;/p&gt;
&lt;div class=&quot;gatsby-highlight&quot; data-language=&quot;c&quot;&gt;&lt;pre class=&quot;language-c&quot;&gt;&lt;code class=&quot;language-c&quot;&gt;&lt;span class=&quot;token macro property&quot;&gt;&lt;span class=&quot;token directive-hash&quot;&gt;#&lt;/span&gt;&lt;span class=&quot;token directive keyword&quot;&gt;include&lt;/span&gt; &lt;span class=&quot;token string&quot;&gt;&amp;lt;WiFi.h&gt;&lt;/span&gt;&lt;/span&gt;
...
&lt;span class=&quot;token keyword&quot;&gt;void&lt;/span&gt; &lt;span class=&quot;token function&quot;&gt;loop&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt; &lt;span class=&quot;token punctuation&quot;&gt;{&lt;/span&gt;
  &lt;span class=&quot;token keyword&quot;&gt;if&lt;/span&gt; &lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token function&quot;&gt;millis&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt; &lt;span class=&quot;token operator&quot;&gt;-&lt;/span&gt; lastTime&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt; &lt;span class=&quot;token operator&quot;&gt;&gt;&lt;/span&gt; timerDelay&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt; &lt;span class=&quot;token punctuation&quot;&gt;{&lt;/span&gt;
    &lt;span class=&quot;token keyword&quot;&gt;if&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;WiFi&lt;span class=&quot;token punctuation&quot;&gt;.&lt;/span&gt;&lt;span class=&quot;token function&quot;&gt;status&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;&lt;span class=&quot;token operator&quot;&gt;==&lt;/span&gt; WL_CONNECTED&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;{&lt;/span&gt;
      &lt;span class=&quot;token function&quot;&gt;sendData&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token number&quot;&gt;1&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;,&lt;/span&gt; &lt;span class=&quot;token number&quot;&gt;2&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;,&lt;/span&gt; &lt;span class=&quot;token number&quot;&gt;3&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;,&lt;/span&gt; &lt;span class=&quot;token number&quot;&gt;4&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;;&lt;/span&gt;
    &lt;span class=&quot;token punctuation&quot;&gt;}&lt;/span&gt;
...
&lt;span class=&quot;token punctuation&quot;&gt;}&lt;/span&gt;&lt;/code&gt;&lt;/pre&gt;&lt;/div&gt;
&lt;p&gt;Again check the serial monitor to see if you connected to wifi and when the data is sent. It will take 60 seconds to send first and then send it again every 60. You should see the points show up on your charts.&lt;/p&gt;
&lt;p&gt;&lt;span
    ...
    style=&quot;padding-bottom: 66.25766871165644%; position: relative; bottom: 0; left: 0; background-image: url(&apos;data:image/png;base64,&apos;); background-size: cover; display: block;&quot;
  &gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source
...
&lt;span class=&quot;token macro property&quot;&gt;&lt;span class=&quot;token directive-hash&quot;&gt;#&lt;/span&gt;&lt;span class=&quot;token directive keyword&quot;&gt;define&lt;/span&gt; &lt;span class=&quot;token expression&quot;&gt;&lt;span class=&quot;token function&quot;&gt;SEALEVELPRESSURE_HPA&lt;/span&gt; &lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token number&quot;&gt;1013.25&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;

&lt;span class=&quot;token keyword&quot;&gt;const&lt;/span&gt; &lt;span class=&quot;token keyword&quot;&gt;char&lt;/span&gt;&lt;span class=&quot;token operator&quot;&gt;*&lt;/span&gt; ssid &lt;span class=&quot;token operator&quot;&gt;=&lt;/span&gt; &lt;span class=&quot;token string&quot;&gt;&quot;Timpani&quot;&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;;&lt;/span&gt;
&lt;span class=&quot;token keyword&quot;&gt;const&lt;/span&gt; &lt;span class=&quot;token keyword&quot;&gt;char&lt;/span&gt;&lt;span class=&quot;token operator&quot;&gt;*&lt;/span&gt; password &lt;span class=&quot;token operator&quot;&gt;=&lt;/span&gt; &lt;span class=&quot;token string&quot;&gt;&quot;W!ll1amM!ncher&quot;&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;;&lt;/span&gt;
...
&lt;span class=&quot;token keyword&quot;&gt;void&lt;/span&gt; &lt;span class=&quot;token function&quot;&gt;setup&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt; &lt;span class=&quot;token punctuation&quot;&gt;{&lt;/span&gt;
  ...
  &lt;span class=&quot;token function&quot;&gt;initBme280&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;;&lt;/span&gt;
...
&lt;span class=&quot;token punctuation&quot;&gt;}&lt;/span&gt;&lt;/code&gt;&lt;/pre&gt;&lt;/div&gt;
&lt;p&gt;Congrats! You should now have live data once a minute. If you ever want to change that time simply change the &lt;em&gt;timerDelay&lt;/em&gt; to the number of milliseconds you want it to wait.&lt;/p&gt;
&lt;p&gt;&lt;span
      class=&quot;gatsby-resp-image-wrapper&quot;
      style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 650px; &quot;
    &gt;
      &lt;span
    class=&quot;gatsby-resp-image-background-image&quot;
    style=&quot;padding-bottom: 66.25766871165644%; position: relative; bottom: 0; left: 0; background-image: url(&apos;data:image/png;base64,&apos;); background-size: cover; display: block;&quot;
  &gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source
...
&lt;p&gt;&lt;span
    ...
    &gt;
      &lt;span
    class=&quot;gatsby-resp-image-background-image&quot;
    style=&quot;padding-bottom: 66.87116564417178%; position: relative; bottom: 0; left: 0; background-image: url(&apos;data:image/jpeg;base64,&apos;); background-size: cover; display: block;&quot;
  &gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source
...
&lt;p&gt;&lt;span
    ...
    &gt;
      &lt;span
    class=&quot;gatsby-resp-image-background-image&quot;
    style=&quot;padding-bottom: 38.65030674846626%; position: relative; bottom: 0; left: 0; background-image: url(&apos;data:image/jpeg;base64,&apos;); background-size: cover; display: block;&quot;
  &gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source
...
&lt;p&gt;&lt;span
    ...
    &gt;
      &lt;span
    class=&quot;gatsby-resp-image-background-image&quot;
    style=&quot;padding-bottom: 66.87116564417178%; position: relative; bottom: 0; left: 0; background-image: url(&apos;data:image/jpeg;base64,&apos;); background-size: cover; display: block;&quot;
  &gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source
...
&lt;/blockquote&gt;
&lt;p&gt;If you are interested in learning more about the IoT and building IoT projects of your own, you’ve come to the right place!  &lt;strong&gt;Stay tuned to our blogs as we will be posting more articles and tutorials on how you can kickstart your journey into the Internet of Things.&lt;/strong&gt;&lt;/p&gt;</content:encoded></item><item><title><![CDATA[About Us]]></title><description><![CDATA[ The TinoIOT (Internet Of Things) Club’s primary objective revolves around the introduction and promotion of engineering and collaboration.  Our mission…]]></description><link>https://tinoiot.com/blogs/about-us/</link><guid isPermaLink="false">https://tinoiot.com/blogs/about-us/</guid><pubDate>Wed, 19 Aug 2020 00:00:00 GMT</pubDate><content:encoded>&lt;img src=&quot;/static/cb58475fb36cea4bba85db52207c51a0/2244e/featured_img.jpg&quot;/&gt;&lt;h2&gt;Our Objective&lt;/h2&gt;
...
&lt;style&gt;
    ...
    table.m-auto:first-of-type{
        margin-top: 20px !important;
    }
    
    table p, table span, table h3{
        margin: 0 !important;
    }
    
    table.officers p, table.officers span, table.officers h3{
       font-size: 84%;
    }
    
    table{
        border-collapse: separate;
        border-spacing: min(2vw, 20px) 10px;
    }
    
    table.presidents .gatsby-resp-image-wrapper, table.presidents img, table.presidents .gatsby-resp-image-background-image{
        width: min(23.5vw, 222px) !important;
        height: calc(min(23.5vw, 222px) * 1.25) !important;
    }
    ...
    table.presidents .gatsby-resp-image-background-image{
        background-size: cover;     
        background-position: center;
    }
    
    table.officers .gatsby-resp-image-wrapper, table.officers img, table.officers .gatsby-resp-image-background-image{
        width: min(18vw, 140px) !important;
        height: calc(min(18vw, 140px) * 1.25) !important;
    }
    
    table.officers h3{
        max-width: calc(min(18vw, 140px) - 10px) !important;
    ...
    table.officers .gatsby-resp-image-background-image{
        background-size: cover;     
        background-position: center;
    ...
    @media only screen and (max-width: 870px) {
        ...
        table.presidents .gatsby-resp-image-wrapper, table.presidents img, table.presidents .gatsby-resp-image-background-image{
            ...
            height: calc(calc((100vw - 90px) / 2) * 1.25) !important;
        }
        ...
        table.officers .gatsby-resp-image-wrapper, table.officers img, table.officers .gatsby-resp-image-background-image{
            ...
            height: calc(calc((100vw - 100px) / 3) * 1.25) !important;
        }
        
        table.officers h3{
            max-width: calc(calc((100vw - 100px) / 3) - 10px) !important;
            text-overflow: ellipsis;
            white-space: nowrap;
            overflow: hidden;
        }
...
&lt;/style&gt;
&lt;table class=&quot;m-auto presidents&quot;&gt;  
&lt;thead&gt;  
&lt;tr&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 650px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 98.15950920245399%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/jpeg;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source srcset=&quot;/static/df5040716020cc4366a2856f34bb6a80/94563/ethan%20zhang.webp 163w,
/static/df5040716020cc4366a2856f34bb6a80/647a8/ethan%20zhang.webp 325w,
/static/df5040716020cc4366a2856f34bb6a80/c1dc5/ethan%20zhang.webp 650w,
/static/df5040716020cc4366a2856f34bb6a80/1e975/ethan%20zhang.webp 975w,
/static/df5040716020cc4366a2856f34bb6a80/063bf/ethan%20zhang.webp 1300w,
/static/df5040716020cc4366a2856f34bb6a80/338ac/ethan%20zhang.webp 1368w&quot; sizes=&quot;(max-width: 650px) 100vw, 650px&quot; type=&quot;image/webp&quot;&gt;
        &lt;source srcset=&quot;/static/df5040716020cc4366a2856f34bb6a80/d2f63/ethan%20zhang.jpg 163w,
/static/df5040716020cc4366a2856f34bb6a80/c989d/ethan%20zhang.jpg 325w,
/static/df5040716020cc4366a2856f34bb6a80/6aca1/ethan%20zhang.jpg 650w,
/static/df5040716020cc4366a2856f34bb6a80/7c09c/ethan%20zhang.jpg 975w,
/static/df5040716020cc4366a2856f34bb6a80/01ab0/ethan%20zhang.jpg 1300w,
/static/df5040716020cc4366a2856f34bb6a80/79446/ethan%20zhang.jpg 1368w&quot; sizes=&quot;(max-width: 650px) 100vw, 650px&quot; type=&quot;image/jpeg&quot;&gt;
        &lt;img class=&quot;gatsby-resp-image-image&quot; src=&quot;/static/df5040716020cc4366a2856f34bb6a80/6aca1/ethan%20zhang.jpg&quot; alt=&quot;Ethan Zhang&quot; title=&quot;Ethan Zhang&quot; loading=&quot;lazy&quot; style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;&gt;
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/th&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 650px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 117.17791411042946%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/jpeg;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source srcset=&quot;/static/96f410faedef06e049db693decbdbb25/94563/sohom%20roy.webp 163w,
/static/96f410faedef06e049db693decbdbb25/647a8/sohom%20roy.webp 325w,
/static/96f410faedef06e049db693decbdbb25/c1dc5/sohom%20roy.webp 650w,
/static/96f410faedef06e049db693decbdbb25/1e975/sohom%20roy.webp 975w,
/static/96f410faedef06e049db693decbdbb25/063bf/sohom%20roy.webp 1300w,
/static/96f410faedef06e049db693decbdbb25/1061e/sohom%20roy.webp 1625w&quot; sizes=&quot;(max-width: 650px) 100vw, 650px&quot; type=&quot;image/webp&quot;&gt;
        &lt;source srcset=&quot;/static/96f410faedef06e049db693decbdbb25/d2f63/sohom%20roy.jpg 163w,
/static/96f410faedef06e049db693decbdbb25/c989d/sohom%20roy.jpg 325w,
/static/96f410faedef06e049db693decbdbb25/6aca1/sohom%20roy.jpg 650w,
/static/96f410faedef06e049db693decbdbb25/7c09c/sohom%20roy.jpg 975w,
/static/96f410faedef06e049db693decbdbb25/01ab0/sohom%20roy.jpg 1300w,
/static/96f410faedef06e049db693decbdbb25/3b53c/sohom%20roy.jpg 1625w&quot; sizes=&quot;(max-width: 650px) 100vw, 650px&quot; type=&quot;image/jpeg&quot;&gt;
        &lt;img class=&quot;gatsby-resp-image-image&quot; src=&quot;/static/96f410faedef06e049db693decbdbb25/6aca1/sohom%20roy.jpg&quot; alt=&quot;Sohom Roy&quot; title=&quot;Sohom Roy&quot; loading=&quot;lazy&quot; style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;&gt;
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/th&gt;  
&lt;/tr&gt;  
&lt;/thead&gt;  
...
&lt;td align=&quot;center&quot;&gt;  
	...
	&lt;/h3&gt;  
	&lt;span&gt;  
	    Co-President&lt;br&gt;&lt;i&gt;Projects Lead&lt;/i&gt;
	&lt;/span&gt;  
&lt;/td&gt;  
&lt;td align=&quot;center&quot;&gt;  
	&lt;h3&gt;  
	...
	&lt;/h3&gt;  
	&lt;span&gt;  
	    Co-President&lt;br&gt;&lt;i&gt;Curriculum Lead&lt;/i&gt;
	&lt;/span&gt;
&lt;/td&gt; 
&lt;/tr&gt;  
&lt;/tbody&gt;  
&lt;/table&gt;
&lt;table class=&quot;m-auto officers&quot;&gt;  
&lt;thead&gt;  
&lt;tr&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 450px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 100%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/png;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source srcset=&quot;/static/34251ab2a824a51fa3195b559429d97b/94563/William.webp 163w,
/static/34251ab2a824a51fa3195b559429d97b/647a8/William.webp 325w,
/static/34251ab2a824a51fa3195b559429d97b/8626f/William.webp 450w&quot; sizes=&quot;(max-width: 450px) 100vw, 450px&quot; type=&quot;image/webp&quot;&gt;
        &lt;source srcset=&quot;/static/34251ab2a824a51fa3195b559429d97b/222b7/William.png 163w,
/static/34251ab2a824a51fa3195b559429d97b/ff46a/William.png 325w,
/static/34251ab2a824a51fa3195b559429d97b/fc2a6/William.png 450w&quot; sizes=&quot;(max-width: 450px) 100vw, 450px&quot; type=&quot;image/png&quot;&gt;
        &lt;img class=&quot;gatsby-resp-image-image&quot; src=&quot;/static/34251ab2a824a51fa3195b559429d97b/fc2a6/William.png&quot; alt=&quot;William Mincher&quot; title=&quot;William Mincher&quot; loading=&quot;lazy&quot; style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;&gt;
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/th&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 400px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 120.85889570552146%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/jpeg;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source srcset=&quot;/static/ca4506c215317e5888ade013b00703e5/94563/maybawl.webp 163w,
/static/ca4506c215317e5888ade013b00703e5/647a8/maybawl.webp 325w,
/static/ca4506c215317e5888ade013b00703e5/7f61c/maybawl.webp 400w&quot; sizes=&quot;(max-width: 400px) 100vw, 400px&quot; type=&quot;image/webp&quot;&gt;
        &lt;source srcset=&quot;/static/ca4506c215317e5888ade013b00703e5/d2f63/maybawl.jpg 163w,
/static/ca4506c215317e5888ade013b00703e5/c989d/maybawl.jpg 325w,
/static/ca4506c215317e5888ade013b00703e5/066f9/maybawl.jpg 400w&quot; sizes=&quot;(max-width: 400px) 100vw, 400px&quot; type=&quot;image/jpeg&quot;&gt;
        &lt;img class=&quot;gatsby-resp-image-image&quot; src=&quot;/static/ca4506c215317e5888ade013b00703e5/066f9/maybawl.jpg&quot; alt=&quot;Mabel Lu&quot; title=&quot;Mabel Lu&quot; loading=&quot;lazy&quot; style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;&gt;
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/th&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 420px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 132.51533742331287%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/png;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
...
/static/540ee4c07b72f8c0e031e04f5c0b5ea4/d10fb/nandu%20upscaled.png 420w&quot; sizes=&quot;(max-width: 420px) 100vw, 420px&quot; type=&quot;image/png&quot;&gt;
        &lt;img class=&quot;gatsby-resp-image-image&quot; src=&quot;/static/540ee4c07b72f8c0e031e04f5c0b5ea4/d10fb/nandu%20upscaled.png&quot; alt=&quot;Nandu S&quot; title=&quot;Nandu S&quot; loading=&quot;lazy&quot; style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;&gt;
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/th&gt;  
&lt;/tr&gt;  
&lt;/thead&gt;  
...
&lt;thead&gt;  
&lt;tr&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 380px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 103.06748466257669%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/jpeg;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
...
/static/95a8218fd8307580df8c220e17fdaa43/0246a/krisha%20chokshi.jpg 380w&quot; sizes=&quot;(max-width: 380px) 100vw, 380px&quot; type=&quot;image/jpeg&quot;&gt;
    ...
    &lt;/span&gt;&lt;/th&gt;  
	&lt;th align=&quot;center&quot;&gt;&lt;span class=&quot;gatsby-resp-image-wrapper&quot; style=&quot;position: relative; display: block; margin-left: auto; margin-right: auto; max-width: 450px; &quot;&gt;
      &lt;span class=&quot;gatsby-resp-image-background-image&quot; style=&quot;padding-bottom: 119.01840490797547%; position: relative; bottom: 0; left: 0; background-image: url(&amp;apos;data:image/jpeg;base64,&amp;apos;); background-size: cover; display: block;&quot;&gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source srcset=&quot;/static/9c86ddd16cbb2b3337dda32cfc108e1f/94563/brian%20chen.webp 163w,
/static/9c86ddd16cbb2b3337dda32cfc108e1f/647a8/brian%20chen.webp 325w,
/static/9c86ddd16cbb2b3337dda32cfc108e1f/8626f/brian%20chen.webp 450w&quot; sizes=&quot;(max-width: 450px) 100vw, 450px&quot; type=&quot;image/webp&quot;&gt;
        &lt;source srcset=&quot;/static/9c86ddd16cbb2b3337dda32cfc108e1f/d2f63/brian%20chen.jpg 163w,
/static/9c86ddd16cbb2b3337dda32cfc108e1f/c989d/brian%20chen.jpg 325w,
/static/9c86ddd16cbb2b3337dda32cfc108e1f/20e5d/brian%20chen.jpg 450w&quot; sizes=&quot;(max-width: 450px) 100vw, 450px&quot; type=&quot;image/jpeg&quot;&gt;
        &lt;img class=&quot;gatsby-resp-image-image&quot; src=&quot;/static/9c86ddd16cbb2b3337dda32cfc108e1f/20e5d/brian%20chen.jpg&quot; alt=&quot;Brian Chen&quot; title=&quot;Brian Chen&quot; loading=&quot;lazy&quot; style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;&gt;
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/th&gt;  
&lt;/tr&gt;  
&lt;/thead&gt;  
...
&lt;p&gt;Take care, &lt;/br&gt;
TinoIoT Exec Team  &lt;/p&gt;</content:encoded></item><item><title><![CDATA[William's Test Page]]></title><description><![CDATA[  The following are resons why they are cool Wikipedia says:   The wild turkey (Meleagris gallopavo) is an upland ground bird…]]></description><link>https://tinoiot.com/pre-prods/william-test-page/</link><guid isPermaLink="false">https://tinoiot.com/pre-prods/william-test-page/</guid><pubDate>Wed, 12 Aug 2020 00:00:00 GMT</pubDate><content:encoded>&lt;img src=&quot;/static/9eac7a5fce2d09ef085f84b4591f2fd3/2244e/wild_turkey.jpg&quot;/&gt;&lt;h2&gt;Hey guys and gals! Lets learn about wild turkeys!&lt;/h2&gt;
&lt;!-- end --&gt;
&lt;h2&gt;Turkeys are pretty cool ngl&lt;/h2&gt;
&lt;p&gt;The following are resons why they are cool&lt;/p&gt;
&lt;ul&gt;
&lt;li&gt;They are birds&lt;/li&gt;
&lt;li&gt;
&lt;p&gt;They can fly&lt;/p&gt;
&lt;ul&gt;
&lt;li&gt;but not &lt;strong&gt;too&lt;/strong&gt; well&lt;/li&gt;
&lt;/ul&gt;
&lt;/li&gt;
&lt;li&gt;They gobble so they cant hurt your feelings *or at least you wouldn’t know if they did**&lt;/li&gt;
&lt;/ul&gt;
&lt;h2&gt;What does the internet say about turkeys?&lt;/h2&gt;
&lt;p&gt;Wikipedia says: &lt;/p&gt;
&lt;blockquote&gt;
&lt;p&gt;The wild turkey (Meleagris gallopavo) is an upland ground bird native to North America, one of two extant species of turkey, and the heaviest member of the diverse Galliformes. It is the same species as the domestic turkey, which was originally derived from a southern Mexican subspecies of wild turkey (not the related ocellated turkey). Although native to North America, the turkey probably got its name from the domesticated variety being imported to Britain in ships coming from the Levant via Spain. The British at the time therefore associated the wild turkey with the country Turkey and the name prevails. [2][3][4] An alternative theory posits that another bird, a guinea fowl native to Madagascar introduced to England by Turkish merchants, was the original source, and that the term was then transferred to the New World bird by English colonizers with knowledge of the previous species.&lt;/p&gt;
&lt;/blockquote&gt;
&lt;p&gt;&lt;span
      class=&quot;gatsby-resp-image-wrapper&quot;
    ...
    &gt;
      &lt;span
    class=&quot;gatsby-resp-image-background-image&quot;
    style=&quot;padding-bottom: 74.84662576687117%; position: relative; bottom: 0; left: 0; background-image: url(&apos;data:image/jpeg;base64,&apos;); background-size: cover; display: block;&quot;
  &gt;&lt;/span&gt;
  &lt;picture&gt;
        &lt;source
          srcset=&quot;/static/9eac7a5fce2d09ef085f84b4591f2fd3/94563/wild_turkey.webp 163w,
/static/9eac7a5fce2d09ef085f84b4591f2fd3/647a8/wild_turkey.webp 325w,
/static/9eac7a5fce2d09ef085f84b4591f2fd3/d3be9/wild_turkey.webp 480w&quot;
          sizes=&quot;(max-width: 480px) 100vw, 480px&quot;
          type=&quot;image/webp&quot;
        /&gt;
        &lt;source
          srcset=&quot;/static/9eac7a5fce2d09ef085f84b4591f2fd3/d2f63/wild_turkey.jpg 163w,
/static/9eac7a5fce2d09ef085f84b4591f2fd3/c989d/wild_turkey.jpg 325w,
/static/9eac7a5fce2d09ef085f84b4591f2fd3/7cc5e/wild_turkey.jpg 480w&quot;
          sizes=&quot;(max-width: 480px) 100vw, 480px&quot;
          type=&quot;image/jpeg&quot;
        /&gt;
        &lt;img
          class=&quot;gatsby-resp-image-image&quot;
          src=&quot;/static/9eac7a5fce2d09ef085f84b4591f2fd3/7cc5e/wild_turkey.jpg&quot;
          alt=&quot;turkey.jpg&quot;
          title=&quot;turkey.jpg&quot;
          loading=&quot;lazy&quot;
          style=&quot;width:100%;height:100%;margin:0;vertical-align:middle;position:absolute;top:0;left:0;&quot;
      ...
      &lt;/picture&gt;
    &lt;/span&gt;&lt;/p&gt;
&lt;p&gt;Learn more on the &lt;a href=&quot;https://en.wikipedia.org/wiki/Wild_turkey&quot;&gt;Turkey fan page&lt;/a&gt;&lt;/p&gt;
&lt;h2&gt;Turkey.js&lt;/h2&gt;
&lt;p&gt;Here is my turkey code (dw if you cant figure it out rn cause its kinda complex):&lt;/p&gt;
&lt;div class=&quot;gatsby-highlight&quot; data-language=&quot;javascript&quot;&gt;&lt;pre class=&quot;language-javascript&quot;&gt;&lt;code class=&quot;language-javascript&quot;&gt;&lt;span class=&quot;token function&quot;&gt;$&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;document&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;.&lt;/span&gt;&lt;span class=&quot;token function&quot;&gt;ready&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token keyword&quot;&gt;function&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt; &lt;span class=&quot;token punctuation&quot;&gt;{&lt;/span&gt;
    console&lt;span class=&quot;token punctuation&quot;&gt;.&lt;/span&gt;&lt;span class=&quot;token function&quot;&gt;log&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;(&lt;/span&gt;&lt;span class=&quot;token string&quot;&gt;&apos;I like turkeys&apos;&lt;/span&gt;&lt;span class=&quot;token punctuation&quot;&gt;)&lt;/span&gt;
